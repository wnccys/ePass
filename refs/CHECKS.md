...
- [x] Valor social, ambiental ou comunitário;
    - [x] Explicado na documentação e vídeo-pitch;
...
- [x] Qual métrica de impacto está sendo acompanhada;
    - [x] Tempo economizado
    - [x] Valores de processos bancários economizados
...
- [x] Como a solução aumenta transparência e confiança.
    - [x] Explicado na documentação
...
- [x] Clareza sobre quais dados ficam on-chain e quais ficam off-chain;
    - [x] Especificado na documentação
