            ...
            <LiquidGlassNavbar>
                <div className="flex w-full items-center justify-between gap-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link
                            href="/login"
                            className={`group glass-input inline-flex cursor-pointer items-center justify-center gap-2 rounded-full px-5 py-2 font-semibold text-sm transition-all hover:scale-[1.02] active:scale-[0.98] ${textColor} border border-foreground/10 hover:border-foreground/20`}
                        >
                            {t("nav.enterApp")}
                            <ArrowRight
