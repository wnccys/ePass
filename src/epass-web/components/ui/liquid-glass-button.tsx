...
const glassButtonVariants = cva(
    "relative isolate inline-flex cursor-pointer items-center justify-center gap-2 rounded-full tracking-tight transition-transform duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/50 disabled:cursor-not-allowed disabled:opacity-50",
    {
        variants: {
            size: {
                default: "px-6 py-3.5 font-medium text-base",
                sm: "px-4 py-2 font-medium text-sm",
                lg: "px-8 py-4 font-medium text-lg",
        ...
        */}
        ...
        `}</style>
                ...
                >
                    ...
                    <span className="btn-liquid-lens pointer-events-none absolute inset-0 -z-10 rounded-[inherit]" />
...
export { GlassButton, glassButtonVariants, WEBP_DISPLACEMENT_MAP };
