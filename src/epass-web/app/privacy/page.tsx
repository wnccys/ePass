...
export default function PrivacyAndTerms() {
    ...
    const content = {
        en: {
            ...
            subtitle:
                "Legal framework and data guidelines for the ePass decentralized agreement protocol.",
        ...
        pt: {
            ...
            subtitle:
                "Estrutura legal e diretrizes de dados para o protocolo descentralizado de acordos ePass.",
    ...
    return (
        <div className="relative min-h-screen w-full text-foreground">
            <main className="relative flex h-full min-h-screen w-full flex-col items-center justify-start overflow-x-hidden px-4 pt-28 pb-16">
                <PublicNavbar />
                ...
                <div className="z-10 flex w-full max-w-4xl flex-col gap-6">
                    <div className="flex items-center gap-3">
                        <Link
                            ...
                            className="glass-input inline-flex items-center gap-2 rounded-full border border-foreground/10 px-4 py-2 font-semibold text-muted-foreground text-xs transition-colors hover:text-foreground"
                        >
                    ...
                    <FadeIn className="w-full">
                        <Card className="glass-panel flex flex-col gap-8 rounded-3xl border border-foreground/10 p-6 shadow-2xl transition-all duration-500 hover:border-primary/40 hover:shadow-[0_0_50px_oklch(from_var(--primary)_l_c_h_/_15%)] md:p-10">
                            {/* Header */}
                            <div className="border-foreground/10 border-b pb-6">
                                <h1 className="mb-2 font-light font-serif text-2xl text-foreground md:text-3xl">
                                    {tData.title}
                                </h1>
                                <p className="text-muted-foreground text-sm">
                                    {tData.subtitle}
                                </p>
                                <span className="mt-4 block text-muted-foreground/60 text-xs">
                                    {tData.lastUpdated}
                                </span>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="border-foreground/5 border-b pb-2">
                                    <h2 className="flex items-center gap-2 font-medium font-serif text-foreground text-xl tracking-tight md:text-2xl">
                                ...
                                <div className="flex flex-col gap-2 rounded-2xl border border-destructive/20 bg-destructive/10 p-4">
                                ...
                                <div className="flex flex-col gap-8">
                                    {tData.termsSections.map((section, idx) => (
                                        <div
                                            key={idx}
                                            className="flex items-start gap-4 border-foreground/5 border-b pb-6 last:border-0 last:pb-0"
                                        >
                                            <div className="shrink-0 rounded-xl bg-primary/10 p-3">
                                                {section.icon}
                                            </div>
                                            <div className="space-y-3">
                                                <h3 className="font-medium font-serif text-foreground text-md">
                                                    {section.title}
                                                </h3>
                            ...
                            <div className="relative py-4">
                                <div
                                    ...
                                    aria-hidden="true"
                                >
                                    <div className="w-full border-foreground/10 border-t" />
                                </div>
                                <div className="relative flex justify-center">
                                    <span className="flex items-center gap-1.5 rounded-full border border-foreground/10 bg-background/20 px-3 py-1 font-semibold text-muted-foreground text-xs backdrop-blur-xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-col gap-2 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4">
                                    <h3 className="flex items-center gap-2 font-semibold text-amber-500 text-sm">
