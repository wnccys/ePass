...
import { Loader, CheckCircle2, Clock, AlertCircle } from "lucide-react";
...
export default function ContractDetailPage() {
  ...
  const isParty = isClub || isPlayer || isAttorney;
  ...
  return (
    <div className="container max-w-4xl mx-auto py-24 px-6">
      <div className="flex items-start justify-between mb-8">
        ...
        <Badge variant="outline" className="px-4 py-2 text-sm">{agreement.status.replace('_', ' ').toUpperCase()}</Badge>
      </div>
          ...
          <Card className="glass-panel p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <a href={agreement.tokenURI} target="_blank" rel="noreferrer" className="text-primary hover:underline break-all">{agreement.tokenURI}</a>
              </div>
              <div>
