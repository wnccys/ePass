        ...
        <div className="flex w-full flex-1 h-screen items-center justify-center bg-background relative overflow-hidden">
            ...
            >
                <div className="text-center space-y-2">
                    <h1 className="text-3xl font-serif font-light text-foreground">Welcome!</h1>
                        ...
                        <form.Field 
                            ...
                            children={(field) => (
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between glass-input-local rounded-2xl p-4 cursor-pointer" onClick={() => field.handleChange(field.state.value === 'player' ? 'club' : 'player')}>
                                        <div className="flex items-center gap-3">
                                            <div className={cn("p-2 rounded-full transition-colors", field.state.value === 'player' ? "bg-primary/20 text-primary" : "bg-muted text-muted-foreground")}>
                                        ...
                                        <div className="flex items-center gap-3 text-right">
                                            ...
                                            <div className={cn("p-2 rounded-full transition-colors", field.state.value === 'club' ? "bg-secondary/20 text-secondary" : "bg-muted text-muted-foreground")}>
